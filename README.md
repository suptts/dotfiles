...
## A GitHub Codespace with the Powerlevel10k Zsh theme
Bonus: I’ve cloned this repository locally and created a symlink from ~/.zshrc to ~/dotfiles/.zshrc. 
...
### Create an install.sh file to install Zsh theme and plugins
